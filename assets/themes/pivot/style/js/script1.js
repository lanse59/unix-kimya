...
! function (e) {
    ...
    function s() {
        ...
        if (1 == a.length) {
            ...
            if (0 != c.length) {
                ...
                f >= t && 1 == a.children().hasClass("main-header-2") && (a.css("top", "0"), a.children(".main-header-2").css("background-color", "rgba(255, 255, 255, 1)"), a.children(".searchbar").removeAttr("style")), (1 == a.children().hasClass("main-header-1") || 1 == a.children().hasClass("main-header-2") || 1 == a.children().hasClass("main-header-4")) && (767 >= t ? (0 == e(".fix-header").length ? a.after('<div class="fix-header"></div>') : e(".fix-header").css("height", l), a.children().hasClass("main-header-1") && a.children(".main-header-1").css("background-color", "rgba(0, 0, 0, 1)")) : (e(".fix-header").remove(), a.children().hasClass("main-header-1") && a.children(".main-header-1").attr("style", "")))
            } else {
    ...
    function r() {
        ...
        if (1 == a.length) {
            ...
            if (0 == a.children().hasClass("main-header-1") && 0 == a.children().hasClass("main-header-2") && 0 == a.children().hasClass("main-header-4")) 0 == e(".fix-header").length && a.after('<div class="fix-headerx"></div>');
            else {
                if (1 == a.children().hasClass("main-header-2")) {
                    a.css("top", "0px"), a.children(".main-header-2").removeAttr("style"), a.children(".searchbar").css({
                        opacity: "0",
                        visibility: "hidden"
                    });
                ...
                767 >= r ? (0 == e(".fix-header").length ? a.after('<div class="fix-header"></div>') : e(".fix-header").css("height", h), a.children().hasClass("main-header-1") && a.children(".main-header-1").css("background-color", "rgba(0, 0, 0, 1)")) : (e(".fix-header").remove(), a.children().hasClass("main-header-1") && a.children(".main-header-1").attr("style", ""))
            }
